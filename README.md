...
```json
{
  "message": "구미 데이트 장소 추천",
  "sessionId": "브라우저 세션 ID",
  "region": "구미"
}
```
...
```json
{
  "answer": "금오산과 동락공원을 추천합니다.",
  "recommendedPlaceIds": ["123", "456"]
}
```

`recommendedPlaceIds` 또는 `placeIds`가 있으면 챗봇 답변에 장소 버튼이 표시되며,
버튼을 누르면 지도에서 해당 마커로 이동하고 장소 팝업을 엽니다.
